...
define([
    ...
    app.registerController('CtrlOutlierDetection', ['$scope','$rootScope', '$http', '$modal', '$state', '$stateParams', '$filter','FileUploader',
        function ($scope,$rootScope, $http, $modal, $state, $stateParams, $filter,FileUploader) {
            ...
            var myCityChart = echarts.init(document.getElementById('View'));
